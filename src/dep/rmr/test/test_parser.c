...
void testHashFunc() {
    ...
    mu_assert_int_eq( MRHashFunc_CRC12, topo->hashFunc);
    MRClusterTopology_Free(topo);

    q = "MYID 1 HASHFUNC CRC16 SLOTS 1337 "
        "RANGES 1 " 
        "SHARD 1 SLOTRANGE 0 2047 ADDR 7EM5XV8XoDoazyvOnMOxbphgClZPGju2lZvm4pvDl3WHvk4j@10.0.1.7:20293";
    ...
    q = "MYID 1 HASHFUNC CRC1222 SLOTS 1337 "
    "RANGES 1 " 
    "SHARD 1 SLOTRANGE 0 2047 ADDR 7EM5XV8XoDoazyvOnMOxbphgClZPGju2lZvm4pvDl3WHvk4j@10.0.1.7:20293";
