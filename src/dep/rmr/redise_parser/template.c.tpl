...
** None.
*/
void agg_ParseTrace(FILE *TraceFILE, char *zTracePrompt) {
...
*/
void *agg_ParseAlloc(void *(*mallocProc)(size_t)) {
  yyParser *pParser;
...
** </ul>
*/
void agg_ParseFree(void *p,                 /* The parser to be deleted */
...
** None.
*/
void agg_Parse(void *yyp,             /* The parser */
      ...
      */
      ...
      if (yymx == YYERRORSYMBOL || yyerrorhit) {
        ...
        while (yypParser->yyidx >= 0 && yymx != YYERRORSYMBOL &&
               (yyact = yy_find_reduce_action(yypParser->yystack[yypParser->yyidx].stateno,
